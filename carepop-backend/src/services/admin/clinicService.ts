...
export const clinicService = {
  create: async (clinicData: CreateClinicDTO) => {
    ...
    if (error) {
      ...
      throw new HttpError('Failed to create clinic.', 500);
    }
    return data;
  },
  ...
  getAll: async (searchQuery?: string) => {
    ...
    if (error) {
      ...
      throw new HttpError('Failed to fetch clinics.', 500);
    }
    return data;
  },
  ...
  getById: async (id: string) => {
    ...
    if (error) {
        ...
        throw new HttpError('Failed to fetch clinic.', 500);
    }
    return data;
  },
  ...
  update: async (id: string, clinicData: UpdateClinicDTO) => {
    ...
    if (error) {
        ...
        throw new HttpError('Failed to update clinic.', 500);
    }
    return data;
  },
  ...
  delete: async (id: string) => {
    ...
    if (error) {
      ...
      throw new HttpError('Failed to delete clinic.', 500);
    }
