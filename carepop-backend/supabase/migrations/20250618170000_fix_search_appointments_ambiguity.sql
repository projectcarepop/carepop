-- Corrects the ambiguous user_id reference in the search_appointments function
...
BEGIN
    ...
    WHERE
        ...
        (p_user_id IS NULL OR a.user_id = p_user_id) AND -- Corrected ambiguous reference
