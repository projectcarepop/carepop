...
import { Provider } from './ProviderTable.server';
...
interface ProviderTableClientProps {
  data: Provider[];
  totalRecords: number;
}

export function ProviderTableClient({ data, totalRecords }: ProviderTableClientProps) {
  ...
  const currentSort = searchParams.get('sort') || 'last_name.asc';
