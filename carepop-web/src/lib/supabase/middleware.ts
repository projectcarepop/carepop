...
export async function updateSession(request: NextRequest) {
  ...
  const publicPaths = ['/', '/about', '/contact', '/clinic-finder', '/download-app', '/sign-in', '/sign-up', '/forgot-password', '/update-password', '/auth/callback', '/auth/confirm', '/terms-of-service', '/privacy-policy']
